  ...
  stories: [
    ...
    Zuck.buildTimelineItem(
      ...
      [
        ...
        ["user1-story1", "photo", 5, "assets/images/albums/01.html", "", '', false, false, timestamp()],
        ["user1-story2", "video", 0, "assets/images/videos/video-call.mp4", "", '', false, false, timestamp()],
        ["user1-story3", "photo", 5, "assets/images/albums/02.html", "", 'https://webestica.com/', 'Visit my Portfolio', false, timestamp()]
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user2-story1", "photo", 5, "assets/images/albums/03.html", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user3-story1", "photo", 5, "assets/images/albums/04.html", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user4-story1", "photo", 5, "assets/images/albums/05.html", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user5-story1", "photo", 5, "assets/images/albums/06.html", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      "user-6",
      "assets/images/post/1by1/07.html",
      "Joan Wallace",
      "",
      timestamp(),
      [
        ["user6-story1", "photo", 5, "assets/images/albums/06.html", "", '', false, false, timestamp()],
      ]
    ),
